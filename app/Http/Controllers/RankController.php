    ...
    public function index(Request $request)
    {
        ...
        $ranks = Rank::where('is_active', true)
            ...
            ->map(fn($rank) => [
                ...
                'icon' => $rank->icon ? asset('uploads/' . $rank->icon) : null,
        ...
        $currentRank = $user->rank ? [
            ...
            'icon' => $user->rank->icon ? asset('uploads/' . $user->rank->icon) : null,
        ...
        $rankHistory = UserRankHistory::where('user_id', $user->id)
            ...
            ->map(fn($history) => [
                ...
                'rank_icon' => $history->rank?->icon ? asset('uploads/' . $history->rank->icon) : null,
