...
class WithdrawController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get user's linked withdrawal accounts count
        $linkedAccountsCount = $user->linkedWithdrawalAccounts()
            ->where('is_active', true)
            ->count();

        // Feature flags from settings
        $bankWithdrawalEnabled = (bool) Setting::get('feature_bank_withdrawal', true);
        $expressWithdrawalEnabled = (bool) Setting::get('feature_express_withdrawal', true);
        ...
        return Inertia::render('Withdraw/Index', [
            ...
            'bankWithdrawalEnabled' => $bankWithdrawalEnabled,
            'expressWithdrawalEnabled' => $expressWithdrawalEnabled,
