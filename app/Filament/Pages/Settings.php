...
class Settings extends Page
{
    ...
    public function mount(): void
    {
        ...
        $this->form->fill([
            ...
            'feature_exchange' => Setting::get('feature_exchange', true),
                                ...
                                Forms\Components\Section::make('Platform Features')
                                    ...
                                    ->schema([
                                        Forms\Components\Grid::make(4)->schema([
                                            ...
                                            Forms\Components\Toggle::make('feature_exchange')
                                                ->label('Exchange')
                                                ->helperText('Currency conversion')
                                                ->default(true),
                                        ]),
                                    ]),
    ...
    public function submit(): void
    {
        ...
        Setting::set('feature_exchange', $state['feature_exchange'] ?? false, 'features', 'boolean');
