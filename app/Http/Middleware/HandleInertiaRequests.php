        ...
        return [
            ...
            'auth' => [
                ...
                'permissions' => $user ? [
                    ...
                    'withdrawal_status' => $user->withdrawal_status ?? 'approved',
                    'withdrawal_message' => $user->withdrawal_message,
                ] : null,
                'impersonating' => $request->session()->has('impersonator_id'),
            ],
            'settings' => [
                'site_name' => Setting::get('site_name', 'National Resource Benefits'),
                'site_logo' => Setting::get('site_logo') ? asset('uploads/' . Setting::get('site_logo')) : null,
                'site_logo_dark' => Setting::get('site_logo_dark') ? asset('uploads/' . Setting::get('site_logo_dark')) : null,
                'site_favicon' => Setting::get('site_favicon') ? asset('uploads/' . Setting::get('site_favicon')) : null,
                ...
                'seo_og_image' => Setting::get('seo_og_image') ? asset('uploads/' . Setting::get('seo_og_image')) : null,
