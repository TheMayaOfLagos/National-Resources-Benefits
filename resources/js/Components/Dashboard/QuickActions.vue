...
const quickActions = computed(() => [
    {
        ...
        show: features.value.deposit !== false && permissions.value.can_deposit,
    ...
    },
    {
        ...
        show: features.value.transfer !== false && permissions.value.can_transfer && (settings.value.transfer_internal_active || settings.value.transfer_self_active),
    ...
    },
    {
        ...
        show: features.value.withdraw !== false && permissions.value.can_withdraw,
    ...
    },
    {
        ...
        show: features.value.voucher !== false && permissions.value.can_use_voucher,
    ...
    },
    {
        ...
        show: features.value.loans !== false && settings.value.loans_enabled,
    ...
    },
    {
        ...
        show: features.value.grants !== false,
    ...
    },
    {
        ...
        show: features.value.funding_sources !== false,
    ...
    },
    {
        ...
        show: features.value.support !== false,
...
<template>
    <div class="bg-white dark:bg-gray-800 rounded-xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <div class="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-8 gap-3">
            <Link v-for="action in displayedActions" :key="action.label" :href="route(action.route)"
                :title="action.description" :aria-label="`${action.label}: ${action.description}`"
