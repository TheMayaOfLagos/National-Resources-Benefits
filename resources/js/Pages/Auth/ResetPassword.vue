            ...
            <div
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <InputText id="email" v-model="form.email" type="email"
                                class="w-full input-with-icon bg-gray-50 dark:bg-zinc-700" readonly />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <InputText id="password_confirmation" v-model="form.password_confirmation"
                                :type="showConfirmPassword ? 'text' : 'password'" class="w-full input-with-icon-both"
                ...
                <div class="mt-6 text-center">
                    <Link :href="route('login')"
                        class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white inline-flex items-center gap-2">
